...
export function generateCanceledEventEmailTemplate(
...
<head>
  ...
  <title>Cancelación de evento</title>
  <style>
    ...
    <div class="email-card">
      ...
      <div class="header">
        <div class="header-content">
          ...
          <p>Lamentamos informarte que este evento ya no se llevará a cabo</p>
      ...
      <div class="content">
        <div class="greeting">
          <h2>Hola ${userName || "invitado/a"},</h2>
          <p>Sabemos que esperabas con entusiasmo este evento, pero por motivos imprevistos ha tenido que cancelarse.</p>
        </div>
        ...
        <div class="important-note">
          <p><strong>Nota:</strong> Te pedimos una sincera disculpa por cualquier inconveniente que esto pueda ocasionar.  
          Esperamos poder contar contigo en futuros eventos.</p>
        </div>
      </div>
