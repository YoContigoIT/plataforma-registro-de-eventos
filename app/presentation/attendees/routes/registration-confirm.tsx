...
export default function RegistrationConfirm() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-muted-foreground/10 to-muted-foreground/20">
      <Card className="w-full max-w-2xl shadow-xl border-0 bg-background">
        <CardContent className="p-8">
          <div className="flex flex-col items-center justify-center py-8 text-center">
            <div className="relative mb-6">
              <div className="rounded-full bg-emerald-500/10 p-5 animate-pulse">
                <CheckCircle className="h-16 w-16 text-emerald-500" />
              </div>
              <div className="absolute inset-0 rounded-full border-4 border-emerald-500/20 animate-ping opacity-20"></div>
            </div>
